...
def desc_calc():
    ...
    base_path = ".\\PaDEL-Descriptor\\"
    xml_file = "PubchemFingerprinter.xml"
    output_file = "descriptors_output.csv"

    bashCommand = f"java -Xms2G -Xmx2G -Djava.awt.headless=true -jar {os.path.join(base_path, 'PaDEL-Descriptor.jar')} -removesalt -standardizenitro -fingerprints -descriptortypes {os.path.join(base_path, xml_file)} -dir .\\ -file {output_file}"
